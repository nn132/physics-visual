// ==========================================
// Cloudflare Worker: physics-visual-worker
// ==========================================
// 这是修复后的完整代码，请复制全部内容到 Cloudflare Dashboard
//
// 部署方法：
// 1. 登录 https://dash.cloudflare.com
// 2. 点击左侧 Workers & Pages
// 3. 找到 physics-visual-worker
...
async function handleRequest(request) {
  ...
  if (url.pathname === '/api/parse-problem') {
    ...
    if (!description) {
      return jsonResponse({ success: false, error: 'Missing description field' }, 400);
    }
